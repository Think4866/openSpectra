      ...
      <div id="myModaluploadConfirm" class="customizedModal modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-footer">
         <a href="#myModalupload" role="button" class="closeCustomizedModal buttoninline my-upload-btn" data-toggle="modal" data-dynamic="true" data-dismiss="modal" aria-hidden="true"><i class="icon-upload"> </i> Upload another set</a>&nbsp;&nbsp;<button class="btn closeCustomizedModal buttoninline" data-dismiss="modal" aria-hidden="true">OK</button>
        </div>
      </div>
