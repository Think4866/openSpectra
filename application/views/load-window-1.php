      ...
      <div class="load-window-1" style="display:none;">
        ...
        <div class="graph-window-1 filldata1 graph span6">
        ...
        <div id="set-info-1" class="info span6">           <!-- set info display -->
          ...
          <div id="set-tools-1" class="set_tools span12">
               <ul class="row-one-tools pull-right">
                    ...
                    <li><a class="remove-loaded-set" id="remove-loaded-set-1" href="#"><i class="tools icon-remove" title="remove" data-toggle="tooltip"></i></a></li>
